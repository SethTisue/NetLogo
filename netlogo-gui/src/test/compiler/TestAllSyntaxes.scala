...
class TestAllSyntaxes extends FunSuite {
  ...
  val REPORTERS = """|_abs number,number,OTPL,None,10,1,1
                     ...
                     |_end1 ,turtle,---L,None,10,0,0
                     |_end2 ,turtle,---L,None,10,0,0
                     ...
                     |_myinlinks ,agentset,-T--,None,10,0,0
                     |_mylinks ,agentset,-T--,None,10,0,0
  ...
  val COMMANDS = """|_ask agent or agentset/command block,OTPL,Some(?),0,2,2
                    ...
                    |_createlinkwith agent/command block (optional),-T--,Some(---L),0,2,2
                    ...
                    |_facenowrap agent,-T--,None,0,1,1
